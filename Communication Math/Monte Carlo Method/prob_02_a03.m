...
', var=',num2str(variance1),' (410786004)'],'fontsize',16,'fontname','Helvetica');
fname = 'prob_02_a03_uni(410786004).png';
print (fname, '-dpng'); 
...
', var=',num2str(variance2),' (410786004)'],'fontsize',16,'fontname','Helvetica');
fname = 'prob_02_a03_nor(410786004).png';
print (fname, '-dpng'); 
