...
plot(t,s1,'r-',t,s2,'k-.',t,s3,'g.-',t,s4,'b-',t,s5,'m-'); 
xlabel('t','fontsize',16,'fontname','Helvetica');
ylabel('x(t)','fontsize',16,'fontname','Helvetica');
title('Fourier Series of x(t) (410786004)','fontsize',16,'fontname','Helvetica'); %<-- Fill your id
...
fname = 'prob_fourier_01(410786004).png';  %<-- Fill your id
print (fname, '-dpng'); 
